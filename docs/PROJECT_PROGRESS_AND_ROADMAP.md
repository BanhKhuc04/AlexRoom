...
| Phase 7 — Backend/hardware | **Software slice PASS** | MQTT V1, SSE, SQLite v2, firmware source và digital twin; chưa kiểm thử ESP thật |
...
| Firmware compile | **CHƯA CHẠY** |
| Firmware flash | **CHƯA CHẠY** |
| ESP8266 vật lý | **CHƯA KIỂM THỬ** |
...
- Node `esp01` và LED thử nghiệm trong lần kiểm thử hiện tại.
...
### Cần MQTT và phần cứng

- Điều khiển ESP8266/LED vật lý.
- Relay và sensor thật.
- Heartbeat/RSSI/telemetry từ thiết bị thật.
- Xác nhận command bằng ACK/reported state do firmware thật phát ra.
...
1. Chưa compile và flash firmware ESP8266 trong môi trường thật.
2. Chưa có kiểm thử end-to-end với thiết bị vật lý.
